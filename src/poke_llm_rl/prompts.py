...
def build_prompt_text(
    ...
    return (
       ...
       # "2. Flip new event flags.\n"
        ...
        #"- REPLY WITH ONLY ONE SENTENCE OF REASONING THEN IMMEDIATELY GIVE THE BUTTONS.\n"
        #"- DO NOT EXPLAIN YOUR REASONING. OUTPUT ONLY THE EXACT BUTTON SEQUENCE."
       ...
       # "Your ENTIRE response must ONLY BE THE ACTIONS!!! Do not think or reason.\n"
    )
